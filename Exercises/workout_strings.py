...
def strsort(in_str: str):
    """
    writing a function, strsort, that takes a single string as its input and returns a string.
    ...
    value. For example, the result of invoking strsort('cba') will be the string abc.
    :return:
    """
